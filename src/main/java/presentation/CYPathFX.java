...
public class CYPathFX extends Application {
    ...
    /**
     * The service used to run the game behind the graphical interface
     */
    ...
    public void initializeGame(int nbPlayers) {
        ...
        if(this.getService() == null) {
            this.setService(new Service<Void>(){
                @Override
    ...
    /**
     * Get the service used to run the game behind the graphical interface
     * 
     * @return Service associated to the game
     */
    ...
    /**
     * Set the service used to run the game behind the graphical interface
     * @param service New service associated to the game
     */
